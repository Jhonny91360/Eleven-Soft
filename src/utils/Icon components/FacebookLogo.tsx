...
const FacebookLogo=({color}:Props)=>{
    return(
<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-facebook-filled" width="60" height="60" viewBox="0 0 24 24" stroke-width="1.5" stroke={color??"#2c3e50"} fill="none" stroke-linecap="round" stroke-linejoin="round">
